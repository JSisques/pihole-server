...
# Paso 5: Ejecutar Docker Compose para iniciar el servidor de PiHole
echo "Paso 5: Iniciando el servidor de PiHole con Docker Compose..."
docker-compose up -d
echo "El servidor de PiHole se está ejecutando en segundo plano."